#!/usr/bin/env python
# -*- coding: utf-8 -*-
#Last-modified: 27 Apr 2015 10:33:48 AM
#
...
def argParser():
    ...
    p.add_argument("-S","--bwfS",dest="bwfS",type=str,metavar='prefix',required=False,default=None,help="Prefix of loop (S) BigWig file(s). For example, for GM12878_S1_plus.bw and GM12878_S1_minus.bw, the prefix is 'GM12878_S1'.")
    p.add_argument("-V","--bwfV",dest="bwfV",type=str,metavar='prefix',required=False,default=None,help="Prefix of stem (V) BigWig file(s). For example, for GM12878_V1_plus.bw and GM12878_V1_minus.bw, the prefix is 'GM12878_V1'.")
