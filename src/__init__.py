#!/usr/bin/env python
# -*- coding: utf-8 -*-
#Last-modified: 26 Mar 2015 02:57:11 PM
...
class Predictor(object):
    ...
    '''
    def FoldMerge(tfastc, T = 37, threshold = 0., predictors=['rnafold','rnastructure','pknots','unaold','sfold'],**kwargs):
        ''' Merge the folded structures from multiple software. '''
        predictor_dict = {'rnafold': Predictor.RNAfold, 'rnastructure': Predictor.Fold, 'fold':Predictor.Fold, 'pknots':  Predictor.pknots, 'mfold':  Predictor.mfold, 'unafold':  Predictor.UNAFold, 'sfold':Predictor.sfoldext,'pknotsrg':Predictor.pknotsRG, 'ipknot':Predictor.ipknot}
        structures = []
        scores = []
